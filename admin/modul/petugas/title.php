          ...
          <ul class="nav navbar-top-links navbar-right">
            <li class="dropdown">
                <a class="dropdown-toggle" data-toggle="dropdown" href="#" style="padding: 10px 15px;">
                  <img src="../images/admin/<?php echo $r['foto']; ?>" height="30" style="border-radius: 50%; margin-right: 5px;"> 
                ...
                <div class="panel panel-default">
                    <div class="panel-heading">
                        <button type="button" class="btn btn-primary" data-toggle="modal" data-target="#exampleModalCenter">
                            <i class="fa fa-plus fa-fw"></i> Tambah Data Petugas
                        </button>
                    </div>
                        ...
                        <div class="table-responsive">
                            <table class="table table-striped table-bordered table-hover"> 
                                ...
                                <tbody>
                                    ...
                                    <?php 
                                    // Paging dan data petugas harus diproses di sini
                                    include 'paging.php';
                                    ?>
