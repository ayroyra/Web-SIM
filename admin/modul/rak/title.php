                ...
                <div class="panel panel-default">
                    <div class="panel-heading">
                        <button type="button" class="btn btn-primary" data-toggle="modal" data-target="#exampleModalCenter">
                            <i class="fa fa-plus fa-fw"></i> Tambah Data Rak
                        </button>
                    </div>
                        ...
                        <div class="table-responsive">
                            <table class="table table-striped table-bordered table-hover"> 
                                ...
                                <tbody>
                                    ...
                                    <?php 
                                    // Paging dan data rak harus diproses di sini
                                    include 'paging.php';
                                    ?>
          ...
          <div class="modal-body">
            <form action="?m=rak&s=simpan" method="POST" enctype="multipart/form-data">
                <div class="form-group">
                    <label for="inputNamaRak">Nama</label>
                    <input type="text" class="form-control" id="inputNamaRak" name="nama_rak" placeholder="Masukkan Nama Rak">
                    <small class="form-text text-muted">Masukkan Nama Rak</small>
                </div>
          </div>
